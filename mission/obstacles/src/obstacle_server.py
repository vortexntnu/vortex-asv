...
class ObstacleServer:
    ...
    def __init__(self) -> None:
        ...
        self.obstacle_sub = rospy.Subscriber('obstacle', Odometry,
                                             self.obstacle_callback)
        self.obstacle_pub = rospy.Publisher('colav_obst',
                                            Odometry,
                                            queue_size=1)
        ...
        self.get_obstacle_service = rospy.Service('get_obstacle', Odometry,
                                                  self.get_obstacle_callback)
