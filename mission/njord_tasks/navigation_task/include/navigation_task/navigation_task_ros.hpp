...
public:
  ...
  /**
   * @brief Predict the positions of the west buoy by using the two first buoy pairs
   *
   * @return An Eigen::Array<double, 2, 3> representing the predicted positions
   * of the second buoy pair and the west buoy
   */
  Eigen::Array<double, 2, 3> predict_west_buoy(const geometry_msgs::msg::Point &buoy_0, const geometry_msgs::msg::Point &buoy_1,
  const geometry_msgs::msg::Point &buoy_2, const geometry_msgs::msg::Point &buoy_3);

  /**
   * @brief Predict the positions of the third buoy pair by using the two first buoy pairs
   *
   * @return An Eigen::Array<double, 2, 2> representing the predicted positions
   * of the third buoy pair
   */
  Eigen::Array<double, 2, 2> predict_third_buoy_pair(const geometry_msgs::msg::Point &buoy_0, const geometry_msgs::msg::Point &buoy_1,
  const geometry_msgs::msg::Point &buoy_2, const geometry_msgs::msg::Point &buoy_3);

  /**
   * @brief Predict the positions of the north buoy by using the two first buoy pairs
   *
   * @return An Eigen::Array<double, 2, 3> representing the predicted positions
   * of the third buoy pair and the north buoy
   */
  Eigen::Array<double, 2, 3> predict_north_buoy(const geometry_msgs::msg::Point &buoy_5, const geometry_msgs::msg::Point &buoy_6,
  const Eigen::Vector2d &direction_vector_second_to_third_pair);

  /**
   * @brief Predict the positions of the south buoy by using the two first buoy pairs
   *
   * @return An Eigen::Array<double, 2, 2> representing the predicted positions
   * of the north and south buoys
   */
  Eigen::Array<double, 2, 2> predict_south_buoy(const geometry_msgs::msg::Point &buoy_5, const geometry_msgs::msg::Point &buoy_6,
  const geometry_msgs::msg::Point &buoy_7, const Eigen::Vector2d &direction_vector_second_to_third_pair);

  /**
   * @brief Predict the positions of the fourth buoy pair by using the third buoy pair
   *
   * @return An Eigen::Array<double, 2, 2> representing the predicted positions
