...
public:
   ...
   * pairs
   *
   * @return An Eigen::Array<double, 2, 1> representing the predicted position
   * of the west buoy
   */
   ...
   * of the north buoy
   */
  Eigen::Array<double, 2, 1> predict_north_buoy(
   ...
   */
  Eigen::Array<double, 2, 1> predict_south_buoy(
      const geometry_msgs::msg::Point &buoy_5,
      const geometry_msgs::msg::Point &buoy_6,
      const Eigen::Vector2d &direction_vector_second_to_third_pair);
   ...
   * of the east buoy
   */
  Eigen::Array<double, 2, 1> predict_east_buoy(
   ...
   *
   * @return An Eigen::Array<double, 2, 2> representing the predicted position
