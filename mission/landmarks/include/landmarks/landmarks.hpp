 ...
 * receiving landmark array messages, publishing landmark array messages,
 * publishing occupancy grid messages, publishing pose array messages, handling
