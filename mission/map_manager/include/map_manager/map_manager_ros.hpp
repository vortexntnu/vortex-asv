...
private:
    ...
    geometry_msgs::msg::PolygonStamped processCoordinates(const std::vector<std::array<double, 2>>& coordinates);
    geometry_msgs::msg::PolygonStamped readPolygonFromFile(const std::string& filename);
    ...
    void insert_landmask(nav_msgs::msg::OccupancyGrid& grid, const geometry_msgs::msg::PolygonStamped& polygon);
    void handle_get_map_request(
        const std::shared_ptr<rmw_request_id_t> request_header,
        const std::shared_ptr<nav_msgs::srv::GetMap::Request> request,
        const std::shared_ptr<nav_msgs::srv::GetMap::Response> response);
    void fillOutsidePolygon(nav_msgs::msg::OccupancyGrid& grid, const geometry_msgs::msg::PolygonStamped& polygon);
  ...
  rclcpp::Publisher<geometry_msgs::msg::PolygonStamped>::SharedPtr landmask_pub_;
