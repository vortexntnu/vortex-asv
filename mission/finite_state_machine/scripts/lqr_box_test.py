...
class LQRControllerBoxTest:
    ...
    def __init__(self):
        ...
        self.add_waypoint_publisher = rospy.Publisher("/guidance/lqr/add_waypoint", Point, queue_size=10)
    ...
    def interpolate_and_publish(self, waypoint1, waypoint2):
        ...
        num_intermediate_points = int(np.ceil(distance / INTERPOLATION_STEP_SIZE))

        for i in range(num_intermediate_points + 1):  # +1 to include the endpoint
