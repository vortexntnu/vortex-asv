...
/**
 * @brief a class containing the current setpoint data for wrench, position and
 * orientation
 */
class Setpoints {
public:
   ...
   *
   * @param wrench    A pointer whos value will be set to the current wrench
   * setpoint
   *
   ...
   * @param orientation   The new orientation setpoint, expressed as a
   * quaternion
   */
...
private:
  ...
  Eigen::Vector3d
      m_position; /** 6d vector containing position setpoint values */
  Eigen::Quaterniond
      m_orientation; /** Quaternion containing orientation setpoints   */
