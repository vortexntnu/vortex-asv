...
// TEST(ThrusterInterfaceTest, InterpolateTest) {
//   ThrusterInterface thruster_interface("mapping_file.txt");
//   std::map<double, double> pwm_table = {{0.0, 1000.0}, {1.0, 2000.0}};
//   float force = 0.5;
//   float expected_pwm = 1500.0;
//   float actual_pwm = thruster_interface.interpolate(pwm_table, force);
//   EXPECT_FLOAT_EQ(expected_pwm, actual_pwm);
// }

// TEST(ThrusterInterfaceTest, PwmToBytesTest) {
//   ThrusterInterface thruster_interface("mapping_file.txt");
...
//   thruster_interface.publish_thrust_to_escs(forces);
//   // TODO: Add expectations for the publish_thrust_to_escs function
// }
