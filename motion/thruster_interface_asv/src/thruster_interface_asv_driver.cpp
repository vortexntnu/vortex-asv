...
ThrusterInterfaceASVDriver::ThrusterInterfaceASVDriver(
    short i2c_bus,
...
std::vector<uint16_t> ThrusterInterfaceASVDriver::interpolate_forces_to_pwm(
...
std::vector<uint16_t> ThrusterInterfaceASVDriver::drive_thrusters(
    const std::vector<double>& thruster_forces_array) {
